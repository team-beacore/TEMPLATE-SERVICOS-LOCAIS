...
type IconDef = (props: SVGProps<SVGSVGElement>) => ReactElement
...
export const icons = {
  ...
  hammer: (p: SVGProps<SVGSVGElement>) => (
    <svg {...strokeProps} {...p}>
  ...
  paintbrush: (p: SVGProps<SVGSVGElement>) => (
    <svg {...strokeProps} {...p}>
      ...
      <path d="M9 8c-1.804 2.71-3.97 3.46-6.583 3.948a.507.507 0 0 0-.302.819l7.535 7.536a.48.48 0 0 0 .48-.1.927.927 0 0 1 .195-.15" />
    </svg>
  ),
...
export function Icon({ name, className, ...props }: IconProps) {
  ...
  return <IconComponent className={cn('h-5 w-5 shrink-0', className)} aria-hidden="true" {...props} />
}